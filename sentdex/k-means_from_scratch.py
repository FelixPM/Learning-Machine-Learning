"""K-means algorithm in python from scratch
"""
...
for centroid1 in clf.centroids:
    plt.scatter(clf.centroids[centroid1][0], clf.centroids[centroid1][1],
...
for unknown in unknowns:
    classification1 = clf.predict(unknown)
    plt.scatter(unknown[0], unknown[1], marker="*", color=colors[classification1], s=150, linewidths=5)
